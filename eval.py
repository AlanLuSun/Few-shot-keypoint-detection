...
opts = {
    ...
    'K_shot': 1,
    'M_query': 5,
    'square_image_length': 384,  # 368, 384
    ...
    'use_fused_attention': None,  # 'L2-c', None, 'attmap'
    ...
    'auxiliary_path_mode': 'random',  # 'exhaust', 'predefined', 'random'
    ...
    'eval_compute_var': 2,  # 0, don't compute var in eval; 1, uncorrelated var; 2, covar
    'use_pum': False,  # patches uncertainty module
    ...
    'load_proto': True,
    'memorize_fibers': False,
    'proto_compute_method': 'm',  # 'm': mean; 'ws': weighted_sum
    'eval_with_body_part_protos': True,  # only used in eval
}
...
#----------------- For unseen kps -----------------
# N_way1 = len(testing_kp_category_set)
if opts['N_way'] > len(testing_kp_category_set):
    N_way1 = len(testing_kp_category_set)
else:
    N_way1 = opts['N_way']
episode_generator = EpisodeGenerator(os.path.join(local_json_root, 'cat.json'), N_way=N_way1, K_shot=opts['K_shot'], M_queries=opts['M_query'],
                                     kp_category_set=testing_kp_category_set, order_fixed=order_fixed, vis_requirement='partial_visible', least_support_kps_num=s_kp_num, least_query_kps_num=q_kp_num, episode_type=episode_type)  # partial_visible  full_visible
...
#----------------- For seen kps -----------------
N_way2 = len(training_kp_category_set)
...
print('******final tests******')
# keypointnet.set_eval_status()
print('==============================Test1-unseen kps====================================')
# keypointnet.validate(episode_generator,  20, eval_method=opts['eval_method'])
# keypointnet.validate(episode_generator2, 20, eval_method=opts['eval_method'])
# keypointnet.validate(episode_generator3, 20, eval_method=opts['eval_method'])
# keypointnet.validate(episode_generator4, 20, eval_method=opts['eval_method'])
print('==============================Test2-unseen kps====================================')
# keypointnet.validate2(episode_generator_test, 1000, eval_method=opts['eval_method'])
keypointnet.validate(episode_generator_test, 1000, eval_method=opts['eval_method'])

print('==============================Test3-seen kps======================================')
# keypointnet.validate2(episode_generator_test2, 1000, eval_method=opts['eval_method'])
