...
def predefined_auxiliary_paths():
    ...
    path1 = [
        [keypoint_types.index('bill'), keypoint_types.index('crown')],
        [keypoint_types.index('bill'), keypoint_types.index('nape')],
...
class NABirdDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        category = ("%.4d"%each_sample['classid'])
        keypoints = each_sample['part']      # [x, y, is_visible]
...
if __name__=='__main__':
    anno_path = '/home/changsheng/LabDatasets/BirdDataset/NABird/nabirds/nabird_annotations.json'
    ...
    AnimalPose_image_root = '/home/changsheng/LabDatasets/BirdDataset/NABird/nabirds/images'
    ...
    for each_sample in episode_generator.supports:
        image_path = os.path.join(AnimalPose_image_root, each_sample['filename'])
        keypoints_dict = OrderedDict(zip(KEYPOINT_TYPES, each_sample['part']))
